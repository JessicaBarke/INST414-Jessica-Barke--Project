"""
make_variable_inventory_simple.py

What this notebook does:
    1. Loads the dataset.
    2. Creates a shorter version of the variable inventory.
    3. Saves it to the reports folder.

Why this notebook exists:
    Sometimes the full inventory is too long for quick checks, so this version
    gives me a faster way to confirm names and types without scrolling through
    a huge table. It is mainly for quick reference.
"""
