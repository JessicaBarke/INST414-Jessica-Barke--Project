...
What this script does:
    1. Generates descriptive statistics and plots for key variables
    2. Explores relationships between social media use and outcomes
    3. Saves EDA figures into reports/figures

Why this script exists:
    EDA supported the choices for the final model and helped confirm
    that the research question was worth modeling.
"""
