...
What this notebook does:
    1. Loads the cleaned dataset used for modeling.
    2. Builds a correlation heatmap for the main variables.
    3. Saves the figure so it can be used in Sprint 3.

Why this notebook exists:
    Sprint 3 requires visuals that help explain patterns in the data.
    A heatmap makes it easy to see which variables move together,
    which helps justify the predictors chosen for the logistic model.
"""
