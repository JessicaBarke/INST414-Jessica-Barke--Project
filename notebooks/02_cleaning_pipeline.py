...
What this script does:
    1. Handles missing values and obvious data issues
    2. Creates consistent variable names and types
    3. Writes out cleaned files to data/clean or data/processed

Why this script exists:
    The cleaning decisions affect every later result.
    Putting them in one place makes it easier to audit and explain
    how the final modeling dataset was created.
"""
