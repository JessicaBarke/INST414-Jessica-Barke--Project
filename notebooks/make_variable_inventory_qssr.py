"""
make_variable_inventory_qssr.py

What this notebook does:
    1. Loads the cleaned dataset.
    2. Builds the full variable inventory for the QSSR track.
    3. Saves it to the reports folder so I can reference it in Sprint 3.

Why this notebook exists:
    The QSSR track requires a full variable inventory that explains each column,
    what type it is, and how it will be used later. This notebook creates that
    table so I don't have to do it by hand, and it keeps everything consistent
    with the data cleaning steps.
"""
