...
What this script does:
    1. Sets up the main modeling dataset for the QSSR track
    2. Fits baseline and primary logistic regression models
    3. Saves core metrics and any intermediate results needed in later steps

Why this script exists:
    Sprint 3 needs a clear place where the actual models are trained.
    This script keeps model fitting logic separate from cleaning and EDA
    so it is easy to explain how I went from data to fitted models.
"""
